      ...
      <div className="max-h-[60vh] overflow-y-auto block">
        <table className="w-full text-base border-separate border-spacing-2">
          <thead className="text-left text-gray-500 ">
            <tr>
              <th className="sticky top-0 bg-[#F7F7F7] w-1/10 font-normal">
                Type
              </th>
              <th className="sticky top-0 bg-[#F7F7F7] w-4/10 font-normal">
                Japanese
              </th>
              <th className="sticky top-0 bg-[#F7F7F7] w-4/10 font-normal">
                {getLanguageName(flashcard.language)}
              </th>
              <th className="sticky top-0 bg-white w-1/10"></th>
            </tr>
          </thead>
          <tbody>
            {cards.map((card, key) => {
